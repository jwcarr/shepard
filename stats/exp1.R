...
# Make test_type into a factor
exp1$test_type <- factor(exp1$test_type, levels=c('production', 'comprehension'))

# Make category_system into a factor with the levels organzied as 1D, 1D, 2D
...
# Run model with correctness predicted by test_type and condition with random intercepts for subject
